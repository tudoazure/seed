"use strict";
 (function () {
MerchantPanel.Models.ProductDetail = Backbone.Model.extend({
	defaults: {
    id: "",
    paytmSkuId:"",
    merchantSkuId:"",
  ...
  parse: function(response){
    ...
    if(response.description){
        ...
        if(productDescCollection && productDescCollection.length){
    ...
    product.returnDays = response.return_in_days || 3;
    product.resources = [];
