...
dgClear: function()
{
	...
	{
		$(this).css("backgroundPosition","9% -81px");
		}
	else
	{
		$(this).css("backgroundPosition","9% -39px");
		}	
},
dgEffect: function()
{
...
dgHandle: function()
{
	...
	{
		$.each($("input[name='"+$(elm).prop("name")+"']"),function()
		{
			if(elm!=this)
				$(this).dgUncheck(-1);
		});
...
dgCheck: function(div)
{
	...
	$(div).data('checked',true).css({backgroundPosition:"9%  -81px"});
},
dgUncheck: function(div)
{
	$(this).prop("checked",false);
	if(div != -1)
		$(div).data('checked',false).css({backgroundPosition:"9% -39px"});
	else
		$(this).parent().data("checked",false).css({backgroundPosition:"9% -39px"});
}
});